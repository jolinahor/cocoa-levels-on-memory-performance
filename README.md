...
Results show no significant difference in completion time across cocoa levels, but digestion interval had a significant effect (p < 0.05), with shorter intervals associated with faster performance. Age was also a significant blocking factor explaining substantial variation in memory outcomes.
